    ...
    <article itemscope itemtype="http://schema.org/Article"
      ...
      <figure class="post-gallery parallax">
        ...
        <div class="parallax_bg"
             ...
             style="background-image: url(../../content/recovery/cover.jpg);"></div>
        <header class="portfolio-title style1 entry-header">
          <div class="row align-center">
            <div class="small-12 medium-10 large-10 columns">              
              <h1 class="entry-title" itemprop="name headline">Account Damage Recovery<br>on Linkedin Profile</h1>                 <!-- <h4>Smart home
                  ...
                  <div class="wpb_column columns medium-12 thb-dark-column small-12">
                      ...
                      <div class="testimonial-quote group">
                        <div class="quote-container">
                            <blockquote>
                                <p>I am getting numerous in-mails as I am sending them. <b>It is fraud messages that are killing my reputation!!! Please, resolve it ASAP!”</b></p>
                            </blockquote>                              
                        </div>
                    </div>            
                      <br><br>
                ...
                <div class="row wpb_row vc_inner row-fluid text-left">
                  ...
                  <div class="wpb_column columns medium-12 thb-dark-column small-12">
                      ...
                      <p>I started my investigation by reading and scanning past records of member's requests and messages when they report suspicious activities on their profile or when requesting for access on their restricted accounts.Many times, they also request to undo the damages for their account</p>
                          ...
                          <div class="wpb_column columns medium-12 thb-dark-column small-12">
                              <div class="wpb_column columns medium-4 thb-dark-column small-12">
                                  <img src="../../content/recovery/search.png" style="display:block;margin:auto;"/>
                                  <p class="not-well">AI algorithm detects any suspicious activity  </p>
                              </div>
                              <div class="wpb_column columns medium-4 thb-dark-column small-12">
                              ...
                              <div class="wpb_column columns medium-4 thb-dark-column small-12">
                                  ...
                                  <p class="not-well">Member themself realise their account is been hacked</p>
                              </div>                          
                          </div>                      
...
<!-- red background FFDCBD -->
  ...
  <!-- background EAF5FB -->          
                ...
                <img width="1920" height="1052"
                         ...
                         class="thb_image   attachment-full thb-lazyload lazyload" alt=""
                         sizes="(max-width: 1920px) 100vw, 1920px"
                         data-src="../../content/recovery/session_history_1.png" data-sizes="auto"
                         data-srcset="../../content/recovery/session_history_1.png 1920w, ../../content/recovery/session_history_1.png 768w, ../../recovery/session_history_1.png 700w, ../../recovery/session_history_1.png 600w"/>
                <br><br>
                ...
                <img width="1920" height="1052"
                         ...
                         class="thb_image   attachment-full thb-lazyload lazyload" alt=""
                         sizes="(max-width: 1920px) 100vw, 1920px"
                         data-src="../../content/recovery/session_history_2.png" data-sizes="auto"
                         data-srcset="../../content/recovery/session_history_2.png 1920w, ../../content/recovery/session_history_2.png 768w, ../../recovery/session_history_2.png 700w, ../../recovery/session_history_2.png 600w"/>
                <br><br>
                ...
                <img width="1920" height="1052"
                         ...
                         class="thb_image   attachment-full thb-lazyload lazyload" alt=""
                         sizes="(max-width: 1920px) 100vw, 1920px"
                         data-src="../../content/recovery/session_history_3.png" data-sizes="auto"
                         data-srcset="../../content/recovery/session_history_3.png 1920w, ../../content/recovery/session_history_3.png 768w, ../../recovery/session_history_3.png 700w, ../../recovery/session_history_3.png 600w"/>
                <br><br>
                ...
                <img width="1920" height="1052"
                         ...
                         class="thb_image   attachment-full thb-lazyload lazyload" alt=""
                         sizes="(max-width: 1920px) 100vw, 1920px"
                         data-src="../../content/recovery/session_history_4.png" data-sizes="auto"
        ...
        <div data-midnight="dark-title" class="row wpb_row row-fluid align-center vc_custom_1481595245026">
          <div class="wpb_column columns medium-8 large-8 thb-dark-column small-12">
            <div class="vc_column-inner  ">
              <div class="wpb_wrapper">
                <div class="row wpb_row vc_inner row-fluid text-left"
                <a href="https://www.figma.com/proto/XQ7QNouC5lRL5cr79eejwU/ATO--inspector?page-id=715%3A261499&node-id=715%3A262012&viewport=124%2C276%2C0.024361222982406616&scaling=min-zoom&starting-point-node-id=715%3A261635"><img width="1920" height="1052"
                         src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
  ...
  <div class="portfolio_nav">
    <div class="row full-width-row">
      <div class="small-5 columns">
        <a href="../moderation/" class="post_nav_link prev">
          <div class="inner"><img src="../../content/images/cover/content.png"
                                  alt="Content Moderation"/></div>
      ...
      <div class="small-5 columns">
        <a href="../ibuy/" class="post_nav_link next">
          <div class="inner"><img src="../../content/images/cover/ibuy.jpg"
                                  alt="IBuy"/></div>
